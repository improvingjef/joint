defmodule Joint.Graph do
  ...
  defstruct as: nil, queryable: nil, field: nil, joins: [], search_params: [], optional: false
  ...
  def visit(module, fields, optional) when is_atom(module) and is_list(fields) do
    visit(to_as(module), module, fields, optional)
  end
  ...
  def visit(as, module, field, optional) when is_atom(module) and is_atom(field) do
    visit(as, module, [field], optional)
  end

  def visit(as, module, fields, optional)
      when is_atom(module) and is_atom(as) and is_list(fields) do
    graph = visit(%Graph{queryable: module, as: as, optional: optional}, fields, optional)
  ...
  def association(graph, assoc, fields, optional) do
    ...
    sub_search = visit(association.field, association.related, fields, optional)
